...
a = st.slider("Enter coefficient a:", min_value=-50,  max_value=50,  value=1.0,  step=0.1)
b = st.slider("Enter coefficient b:", min_value=-50,  max_value=50,  value=-3.0,  step=0.1)
c = st.slider("Enter coefficient c:", min_value=-50,  max_value=50,  value=2.0,  step=0.1)
