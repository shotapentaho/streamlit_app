...
# UI
st.title(" 🔐 👷‍♂️  Contractor Xperiences..login or register (new here)")
...
if tab == "Register or renewal membership":
    ...
    with col_2:
        ...
        selected_sub_period = st.selectbox("Membership period:", subscription_labels)
    ...
    if st.button("Register/Renew & Pay"):
